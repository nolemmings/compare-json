 ...
 * Options:
 * {
 *   exitOnError: true, // Process.exit(1) when an error or warning occurred, default true
 *   out: console.log, // Output stream function, default console.log
 * }
 */
module.exports = function(files, options) {
  ...
  compare.compareFiles(files, function(err, results) {
    ...
    if (opts.exitOnError && exitCode > 0) {
      process.exit(1);
    }
    return;
  });
